...
- backend/
  ...
  - src/
    ...
    - modules/ — identity, consent, patient, doctor, catalogue, availability, ai, notification, search, storage, document, booking, payment, presence, video, clinical, followup, clarification, carehub, feedback, governance, audit
